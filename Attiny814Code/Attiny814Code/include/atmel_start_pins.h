 ...
 * \param[in] pull_mode Pin pull mode
 */
static inline void TOUCH_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTA_set_pin_pull_mode(4, pull_mode);
}

/**
 * \brief Set TOUCH data direction
 *
 * Select if the pin data direction is input, output or disabled.
 * If disabled state is not possible, this function throws an assert.
 *
 ...
 *                      (low power state)
 */
static inline void TOUCH_set_dir(const enum port_dir dir)
{
	PORTA_set_pin_dir(4, dir);
}

/**
 * \brief Set TOUCH input/sense configuration
 *
 * Enable/disable TOUCH digital input buffer and pin change interrupt,
 * select pin interrupt edge/level sensing mode
 *
 * \param[in] isc PORT_ISC_INTDISABLE_gc    = Iterrupt disabled but input buffer enabled
 *                PORT_ISC_BOTHEDGES_gc     = Sense Both Edges
 ...
 *                PORT_ISC_LEVEL_gc         = Sense low Level
 */
static inline void TOUCH_set_isc(const PORT_ISC_t isc)
{
	PORTA_pin_set_isc(4, isc);
}

/**
 * \brief Set TOUCH inverted mode
 *
 * Enable or disable inverted I/O on a pin
 *
 * \param[in] inverted true  = I/O on TOUCH is inverted
 *                     false = I/O on TOUCH is not inverted
 */
static inline void TOUCH_set_inverted(const bool inverted)
{
	PORTA_pin_set_inverted(4, inverted);
}

/**
 * \brief Set TOUCH level
 *
 * Sets output level on a pin
 *
 * \param[in] level true  = Pin level set to "high" state
 *                  false = Pin level set to "low" state
 */
static inline void TOUCH_set_level(const bool level)
{
	PORTA_set_pin_level(4, level);
}

/**
 * \brief Toggle output level on TOUCH
 *
 * Toggle the pin level
 */
static inline void TOUCH_toggle_level()
{
	PORTA_toggle_pin_level(4);
}

/**
 * \brief Get level on TOUCH
 *
 * Reads the level on a pin
 */
static inline bool TOUCH_get_level()
{
 ...
 * \param[in] pull_mode Pin pull mode
 */
static inline void IO1_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTB_set_pin_pull_mode(0, pull_mode);
}

/**
 * \brief Set IO1 data direction
 *
 * Select if the pin data direction is input, output or disabled.
 * If disabled state is not possible, this function throws an assert.
 *
 ...
 *                      (low power state)
 */
static inline void IO1_set_dir(const enum port_dir dir)
{
	PORTB_set_pin_dir(0, dir);
}

/**
 * \brief Set IO1 input/sense configuration
 *
 * Enable/disable IO1 digital input buffer and pin change interrupt,
 * select pin interrupt edge/level sensing mode
 *
 * \param[in] isc PORT_ISC_INTDISABLE_gc    = Iterrupt disabled but input buffer enabled
 *                PORT_ISC_BOTHEDGES_gc     = Sense Both Edges
 ...
 *                PORT_ISC_LEVEL_gc         = Sense low Level
 */
static inline void IO1_set_isc(const PORT_ISC_t isc)
{
	PORTB_pin_set_isc(0, isc);
}

/**
 * \brief Set IO1 inverted mode
 *
 * Enable or disable inverted I/O on a pin
 *
 * \param[in] inverted true  = I/O on IO1 is inverted
 *                     false = I/O on IO1 is not inverted
 */
static inline void IO1_set_inverted(const bool inverted)
{
 ...
 *                  false = Pin level set to "low" state
 */
static inline void IO1_set_level(const bool level)
{
	PORTB_set_pin_level(0, level);
}

/**
 * \brief Toggle output level on IO1
 *
 * Toggle the pin level
 */
static inline void IO1_toggle_level()
{
	PORTB_toggle_pin_level(0);
}

/**
 * \brief Get level on IO1
 *
 * Reads the level on a pin
 */
static inline bool IO1_get_level()
{
	return PORTB_get_pin_level(0);
}

/**
 * \brief Set IO2 pull mode
 *
 * Configure pin to pull up, down or disable pull mode, supported pull
 * modes are defined by device used
 *
 * \param[in] pull_mode Pin pull mode
 */
static inline void IO2_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTB_set_pin_pull_mode(1, pull_mode);
}

/**
 * \brief Set IO2 data direction
 *
 * Select if the pin data direction is input, output or disabled.
 * If disabled state is not possible, this function throws an assert.
 *
 ...
 *                      (low power state)
 */
static inline void IO2_set_dir(const enum port_dir dir)
{
	PORTB_set_pin_dir(1, dir);
}

/**
 * \brief Set IO2 input/sense configuration
 *
 * Enable/disable IO2 digital input buffer and pin change interrupt,
 * select pin interrupt edge/level sensing mode
 *
 * \param[in] isc PORT_ISC_INTDISABLE_gc    = Iterrupt disabled but input buffer enabled
 *                PORT_ISC_BOTHEDGES_gc     = Sense Both Edges
 ...
 *                PORT_ISC_LEVEL_gc         = Sense low Level
 */
static inline void IO2_set_isc(const PORT_ISC_t isc)
{
	PORTB_pin_set_isc(1, isc);
}

/**
 * \brief Set IO2 inverted mode
 *
 * Enable or disable inverted I/O on a pin
 *
 * \param[in] inverted true  = I/O on IO2 is inverted
 *                     false = I/O on IO2 is not inverted
 */
static inline void IO2_set_inverted(const bool inverted)
{
 ...
 *                  false = Pin level set to "low" state
 */
static inline void IO2_set_level(const bool level)
{
	PORTB_set_pin_level(1, level);
}

/**
 * \brief Toggle output level on IO2
 *
 * Toggle the pin level
 */
static inline void IO2_toggle_level()
{
	PORTB_toggle_pin_level(1);
}

/**
 * \brief Get level on IO2
 *
 * Reads the level on a pin
 */
static inline bool IO2_get_level()
{
